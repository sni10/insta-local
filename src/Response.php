<?php
     ...
     * @method mixed getFeedTitle()
     * @method mixed getFeedMessage()
    ...
    class Response extends AutoPropertyMapper
    {
        ...
        {
            return $this->_getProperty('message') == 'feedback_required';
        }
        ...
        {
            return $this->_getProperty('feedback_title');
        }
        ...
        {
            return $this->_getProperty('feedback_message');
        }
        
        public function isSpam()
        {
            return $this->_getProperty('spam');
        }
